...
const Citi = require('../../boleto/bancos/citi');
...
var Beneficiario = (function () {
	...
	Beneficiario.prototype.getUsoBanco = function () {
		return this._usoBanco;
	};

	Beneficiario.prototype.comUsoBanco = function (_usoBanco) {
		this._usoBanco = _usoBanco;
		return this;
	};
	...
	Beneficiario.prototype.comNome = function (_nomeBeneficiario) {
		this._nome = _nomeBeneficiario.slice(0,40);
		return this;
	};
	...
	Beneficiario.prototype.getLogo = function () {
		return this._logo;
	};

	Beneficiario.prototype.comLogo = function (_logo) {
		this._logo = _logo;
		return this;
	};
...
var Datas = (function () {
	function formatar(data) {
		const datasInfo = data.split('-');
		return `${datasInfo[2]}/${datasInfo[1]}/${datasInfo[0]}`;
	}
	...
	Datas.prototype.comProcessamento = function (_processamento) {
		this._processamento = _processamento;
...
var Boleto = (function () {
	...
	Boleto.prototype.getCodigoDeBarras = function () {
	...
	Boleto.prototype.getLinhaDigitavel = function () {
